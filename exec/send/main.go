...
import (
	...
	"example.com/m/v2/source/apis/sendService"
...
func main() {
	...
	var (
		...
		sendServices = sendService.NewServiceAsLogger(entry, dbstore)
	)
	...
	{
		sendService.NewHandler(sendServices).AddRoutes(root)
	}
